...
On October 2nd, Behaviour started rolling out dedicated servers for Dead by Daylight for public testing. As such, there is no reason to continue working on this project, as the program will soon be fully unusable.

If I ever somehow find another **legitimate** and simple method to fetch the killer (very unlikely), it'll be created under another repository and program name.
